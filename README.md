...
| Server       | 3.3.0 (latest), 3.2.0, 3.1.0, 3.0.5, 3.0.3, 3.0.2, 3.0.1, 3.0.0 |
| .NET API     | 3.2.0 (latest), 3.1.0, 3.0.2, 3.0.1, 3.0.0                      |
| HTTP API     | 3.2.0 (latest), 3.1.0, 3.0.3, 3.0.2, 3.0.1, 3.0.0               |
