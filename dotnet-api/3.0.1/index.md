...
The code below shows how to connect to an Event Store server, write to a stream, and read back the events. For more detailed information, read the full pages for [Connecting to a Server](./connection-options/), [Reading Specific Streams](./reading-streams/) and [Writing to a Stream](./writing-to-a-stream/)ls
