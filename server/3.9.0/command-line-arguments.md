...
|-Log<br/>--log=VALUE<br/>|LOG|Log|Path where to keep log files. (Default: /Users/hayleyc/Documents/Source/EventStore/EventStore/etc/EventStore.Documentation/bin/Debug/logs) |
...
|-Db<br/>--db=VALUE<br/>|DB|Db|The path the db should be loaded/saved to. (Default: /Users/hayleyc/Documents/Source/EventStore/EventStore/etc/EventStore.Documentation/bin/Debug/data) |
